...
//    ORDERD_NO, WORKER, COMMENTS, CUST_CODE, ORDER_DATE, D_DATE, TOTAL_AMOUNT, ADVANCE_AMOUNT, ORDER_STATUS, C_ID, I_ID, LOMBA, BUK, PET, HIP, KAD, HATA, GOLA, KAF,
//    MOHORI, GER, KOMOR, HIF, THAI, HAI, KOF_DESIGN, KOLOR_DESIGN, POKET_DESIGN, SELAY_DESIGN, CHAIN_DESIGN, ITEM_PRICE, QTY, ITEM_TOTAL_VAL

//    ORDERD_NO, WORKER, COMMENTS, CUST_CODE, ORDER_DATE, D_DATE, TOTAL_AMOUNT, ADVANCE_AMOUNT, ORDER_STATUS, C_ID, I_ID, PRODUCT_NAME, LOMBA, BUK, PET, HIP, KAD, HATA,
//    GOLA, KAF, MOHORI, GER, KOMOR, HIF, THAI, HAI, KOF_DESIGN, KOLOR_DESIGN, POKET_DESIGN, SELAY_DESIGN, CHAIN_DESIGN, ITEM_PRICE, QTY, ITEM_TOTAL_VAL
