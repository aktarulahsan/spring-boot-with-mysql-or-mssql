...
import com.aktarulahsan.erp.tms.setting.designcategory.DesignCategoryService;
import com.aktarulahsan.erp.util.Response;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.*;

@RestController
@RequestMapping("/tms/designSubCategory")
public class DesignSubCatController {



    @Autowired
    DesignSubCatService service;
    ...
    @GetMapping("/findById")
    public Response findorderById(@RequestParam("designCategoryId") String id) {
